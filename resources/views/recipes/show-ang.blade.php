...
<div class="container">
    ...
    {{--{{ Form::model($comment, ['ng-submit' => 'submitComment()']) }}--}}
        <!-- AUTHOR -->
        ...
        <div class="form-group">
            <input type="text" class="form-control input-sm" name="recipe_id" ng-model="commentData.recipe_id" placeholder="{{ $recipe->id }}" value="{{ $recipe->id }}" >
        </div>
